...
class CRouter {
	...
	private array $routes = [
		...
		'popup.scheduledreport.subscription.check'	=> ['CControllerPopupScheduledReportSubscriptionCheck',	'layout.json',			null],
		...
		'scheduledreport.create'					=> ['CControllerScheduledReportCreate',					'layout.json',			null],
		'scheduledreport.delete'					=> ['CControllerScheduledReportDelete',					'layout.json',			null],
		'scheduledreport.disable'					=> ['CControllerScheduledReportDisable',				'layout.json',			null],
		'scheduledreport.edit'						=> ['CControllerScheduledReportEdit',					'layout.json',			'reports.scheduledreport.edit'],
		'scheduledreport.enable'					=> ['CControllerScheduledReportEnable',					'layout.json',			null],
		'scheduledreport.list'						=> ['CControllerScheduledReportList',					'layout.htmlpage',		'reports.scheduledreport.list'],
		'scheduledreport.update'					=> ['CControllerScheduledReportUpdate',					'layout.json',			null],
